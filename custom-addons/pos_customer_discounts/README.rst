...
This module aims in providing special discount for customers in POS on their respective birthday.
...
* Create order for the customers and the discount configured in the settings will be automatically applied to the
  products if the current date is the birthday of customer.
